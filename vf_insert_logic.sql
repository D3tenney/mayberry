...
INSERT INTO former_voter
SELECT voter.*, 'removed from file' AS reason, CURRENT_DATE
FROM voter
...
--Reg Num Change
INSERT INTO former_voter
SELECT *, 'voter reg num', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
--Reg Date Change
INSERT INTO former_voter
SELECT *, 'registration date', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
INSERT INTO former_voter
SELECT *, 'registration address', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
-- Mail Address
INSERT INTO former_voter
SELECT *, 'mailing address', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
-- Party Affiliation
INSERT INTO former_voter
SELECT *, 'party affiliation', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
-- Absentee
INSERT INTO former_voter
SELECT *, 'absentee status', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
INSERT INTO former_voter
SELECT *, 'political geography', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
INSERT INTO former_voter
SELECT *, 'voter status, reason', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
-- Driver License
INSERT INTO former_voter
SELECT *, 'driver license', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
-- Phone Number
INSERT INTO former_voter
SELECT *, 'phone number', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
...
INSERT INTO former_voter
SELECT *, 'demographics', CURRENT_DATE
FROM voter
JOIN voter_staging
  ON voter.ncid = voter_staging.ncid
